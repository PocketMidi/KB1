...
<template>
  <div :class="`settings-lever lever-${props.lever}`">
    ...
    <div class="inputs">
      ...
      <div class="group">
        <label :for="`lever-functionMode-${props.lever}`">Function Mode</label>
        <select :id="`lever-functionMode-${props.lever}`" v-model="value.functionMode">
          <option
            v-for="(param, pdx) in tm('configurator.values.lever.functionModes')"
      ...
      <div class="group">
        <label :for="`lever-valueMode-${props.lever}`">Value Mode</label>
        <select :id="`lever-valueMode-${props.lever}`" v-model="value.valueMode">
          <option
            v-for="(param, pdx) in tm('configurator.values.valueModes')"
            :key="`valuemodes-${pdx}`"
            :value="param.value"
          >
            {{ param.label }}
      ...
      <div class="group">
        ...
        <select :id="`lever-onsetType-${props.lever}`" v-model="value.onsetType">
          <option
      ...
      <div class="group">
        <label :for="`lever-offsetType-${props.lever}`">Decay Type</label>
        <select :id="`lever-offsetType-${props.lever}`" v-model="value.offsetType">
          <option
            v-for="(param, pdx) in tm('configurator.values.interpolations')"
            :key="`offsettype-${pdx}`"
            :value="param.value"
